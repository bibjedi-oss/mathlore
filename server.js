...
МОМЕНТ ОТКРЫТИЯ:
Когда ребёнок своими действиями или словами нащупал суть — отпразднуй и сразу назови это открытие: "Эврика! Ты только что открыл то же самое что и [имя / люди той эпохи]! Это называется [название понятия]." Не заставляй ребёнка угадывать название — оно не очевидно, ты называешь его сам.
